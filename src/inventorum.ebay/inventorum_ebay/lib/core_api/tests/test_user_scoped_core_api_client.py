...
from inventorum_ebay.lib.core_api import FakeCoreAPIResponse
from inventorum_ebay.tests import CoreApiTest
...
from inventorum_ebay.tests.testcases import APITestCase, UnitTestCase
...
class IntegrationTestUserScopedCoreAPIClient(APITestCase):
    ...
    def test_product_with_variations(self):
        ...
        self.assertTrue(first_variation.images[0].urls.ipad_retina.startswith("https://app.inventorum.net/uploads/"))
        ...
        self.assertTrue(second_variation.images[0].urls.ipad_retina.startswith("https://app.inventorum.net/uploads/"))
...
class UnitTestUserScopedCoreAPIClient(UnitTestCase):
    ...
    def mock_core_api_client(self):
        self.client_get_mock = self.patch("inventorum_ebay.lib.core_api.clients.CoreAPIClient.get")
        self.client_post_mock = self.patch("inventorum_ebay.lib.core_api.clients.CoreAPIClient.post")
        self.client_put_mock = self.patch("inventorum_ebay.lib.core_api.clients.CoreAPIClient.put")
        self.client_delete_mock = self.patch("inventorum_ebay.lib.core_api.clients.CoreAPIClient.delete")
