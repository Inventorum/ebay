...
from inventorum_ebay.lib.core_api import CoreChannel
from inventorum_ebay.lib.core_api.models import CoreProductDeserializer, CoreInfoDeserializer, \
...
from inventorum_ebay.apps.inventory.serializers import QuantityCoreApiResponseDeserializer
...
class CoreAPIClient(object):
    ...
    def paginated_get(self, path, limit_per_page, params=None, custom_headers=None):
        ...
        *Note*: The pager immediately requests the first page to initiate the pager accordingly
        ...
        :raises requests.exceptions.RequestException, inventorum_ebay.apps.core_api.pager.PagerException
        """
...
class UserScopedCoreAPIClient(CoreAPIClient):
    ...
    def get_quantity_info(self, product_ids):
        ...
        :rtype: list of inventorum_ebay.apps.inventory.models.CoreQuantity
        :raises requests.exceptions.RequestException
                rest_framework.exceptions.ValidationError
        """
    ...
    def get_paginated_product_delta_modified(self, start_date, limit_per_page=100):
        ...
        :rtype: collections.Iterable[list of inventorum_ebay.apps.core_api.models.CoreProductDelta]
        :raises requests.exceptions.RequestException
                rest_framework.exceptions.ValidationError
        """
    ...
    def create_order(self, data):
        ...
        :rtype: inventorum_ebay.lib.core_api.models.CoreOrder
...
class CoreReturnsClient(object):
    ...
    def get_paginated_delta(self, start_date, limit_per_page=100):
        ...
        :rtype: collections.Iterable[list[inventorum_ebay.lib.core_api.models.CoreDeltaReturn]]
        :raises requests.exceptions.RequestError
                rest_framework.exceptions.ValidationError
        """
        params = {
