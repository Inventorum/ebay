...
from inventorum_ebay.lib.ebay.data.items import EbayAddItemResponse, EbayUnpublishReasons, EbayEndItemResponse, \
...
class EbayItems(EbayTrading):
    def publish(self, item):
        ...
        :type item: inventorum_ebay.lib.ebay.data.items.EbayFixedPriceItem
    ...
    def revise_fixed_price_item(self, revise_fixed_price_item):
        """
        :type revise_fixed_price_item: inventorum_ebay.lib.ebay.data.items.EbayReviseFixedPriceItem
