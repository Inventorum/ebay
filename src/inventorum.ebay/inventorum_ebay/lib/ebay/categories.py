...
from inventorum_ebay.lib.ebay import EbayTrading, EbayParallel
from inventorum_ebay.lib.ebay.data.categories import EbayCategorySerializer, EbayCategory
from inventorum_ebay.lib.ebay.data.categories.features import EbayFeature
from inventorum_ebay.lib.ebay.data.categories.specifics import EbayCategorySpecifics
from inventorum_ebay.lib.ebay.data.categories.suggestions import GetSuggestedCategoriesResponseType
...
class EbayCategories(EbayTrading):
    ...
    def get_specifics_for_categories(self, categories_ids):
        ...
        :rtype: dict[unicode, inventorum_ebay.lib.ebay.data.EbayFeature]
        """
