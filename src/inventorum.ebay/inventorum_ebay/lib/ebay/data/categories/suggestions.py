...
import logging
from inventorum_ebay.lib.ebay.data import EbayArrayField
from inventorum_ebay.lib.ebay.data.categories import EbayCategorySerializer
...
class SuggestedCategoryType(object):
    ...
    def __init__(self, category, percent_item_found):
        """
        :type category: inventorum_ebay.lib.ebay.data.categories.EbayCategory
