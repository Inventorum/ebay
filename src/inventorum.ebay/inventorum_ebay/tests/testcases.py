...
import os
import logging
from inventorum_ebay.tests.utils import PatchMixin, AssertionMixin
import unittest
...
from inventorum_ebay.lib.auth.backends import TrustedHeaderAuthentication
...
class APITestCase(AssertionMixin, PatchMixin, test.APITestCase):
    ...
    @property
    def account(self):
        """ :rtype: inventorum_ebay.apps.accounts.models.EbayAccountModel """
        return self._account

    @property
    def user(self):
        """ :rtype: inventorum_ebay.apps.accounts.models.EbayUserModel """
        return self._user
