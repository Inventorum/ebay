...
from inventorum_ebay.apps.categories import ListingDurations

from django.db.models.fields import CharField, BooleanField, URLField, TextField, IntegerField
from django_countries.fields import CountryField
from inventorum_ebay.lib.db.models import BaseModel, BaseQuerySet
...
class CategoryModel(MPTTModel):
    ...
    def create_or_update_from_ebay_category(cls, data, country_code):
        ...
        :type data: inventorum_ebay.lib.ebay.data.EbayCategory
        :rtype: CategoryModel
        """
...
class CategoryFeaturesModel(BaseModel):
    ...
    def create_or_update_from_ebay_data_for_category(cls, data, category):
        ...
        :return:
        :type data: inventorum_ebay.lib.ebay.data.features.EbayFeature
        """
...
class CategorySpecificModel(BaseModel):
    ...
    def create_or_update_from_ebay_data_for_category(cls, data, category):
        ...
        :type data: inventorum_ebay.lib.ebay.data.categories.specifics.EbayCategorySpecifics
        """
        specifics = []
