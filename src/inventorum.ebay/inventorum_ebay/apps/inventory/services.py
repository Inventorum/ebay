...
class CoreApiQuantityCheck(object):
    def __init__(self, data, location_id, core_api_client):
        ...
        :raises inventorum_ebay.apps.inventory.services.CoreApiQuantityCheckBadLocation
        :type data: list[inventorum_ebay.apps.inventory.models.EbayItemForQuantityCheck]
    ...
    def refresh_quantities(self):
        ...
        :rtype data: list[inventorum_ebay.apps.inventory.models.EbayItemForQuantityCheck]
        """
        product_ids = []
        ebay_items = {}
