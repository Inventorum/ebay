...
import logging
from inventorum_ebay.lib.ebay.data.inventorymanagement import EbayAvailability
...
class EbaySanityCheck(object):
    def __init__(self, trackingUUID, availabilities):
        ...
        :type availabilities: list[inventorum_ebay.apps.inventory.models.EbayItemForQuantityCheck]
        """
