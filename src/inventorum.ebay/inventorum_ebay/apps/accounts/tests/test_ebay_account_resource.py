...
from inventorum_ebay.apps.accounts.serializers import EbayAccountSerializer, EbayLocationSerializer
from inventorum_ebay.apps.accounts.tests.factories import EbayLocationFactory
