...
from inventorum_ebay.lib.auth.models import AuthenticableModelMixin
from inventorum_ebay.lib.db.models import MappedInventorumModel, BaseModel, MappedInventorumModelQuerySet
from inventorum_ebay.lib.ebay.data import BuyerPaymentMethodCodeType
from inventorum_ebay.lib.ebay.data.inventorymanagement import EbayLocation
...
class AddressModel(BaseModel):
    ...
    def create_from_ebay_address(cls, ebay_address):
        ...
        :type ebay_address: inventorum_ebay.lib.ebay.data.EbayUserAddress
        """
...
class EbayLocationModel(BaseModel):
    ...
    def get_ebay_location_object(self, days):
        ...
        :type days: list[inventorum_ebay.lib.ebay.data.inventorymanagement.EbayDay]
        :rtype: EbayLocation
        """
        return EbayLocation(
