...
from inventorum_ebay.apps.accounts.models import ReturnPolicyModel
from inventorum_ebay.apps.products.validators import CategorySpecificsValidator
from inventorum_ebay.lib.core_api.clients import CoreAPIClient
from inventorum_ebay.lib.ebay.data import BuyerPaymentMethodCodeType, EbayConstants, SellerProfileCodeType
from inventorum_ebay.lib.ebay.data.errors import EbayErrorCode
from inventorum_ebay.lib.ebay.data.inventorymanagement import EbayLocationAvailability, EbayAvailability
...
from inventorum_ebay.apps.products import EbayItemPublishingStatus, EbayApiAttemptType, EbayItemUpdateStatus
from inventorum_ebay.apps.products.models import EbayProductModel, EbayItemModel, EbayItemImageModel, \
...
from inventorum_ebay.lib.ebay.items import EbayItems
...
class PublishingPreparationService(object):
    def __init__(self, product, user):
        ...
        :type user: inventorum_ebay.apps.accounts.models.EbayUserModel
        """
    ...
    def core_product(self):
        """
        :rtype: inventorum_ebay.apps.core_api.models.CoreProduct
        """
        try:
    ...
    def core_info(self):
        """
        :rtype: inventorum_ebay.apps.core_api.models.CoreInfo
        """
        try:
    ...
    def core_account(self):
        """
        :rtype: inventorum_ebay.lib.core_api.models.CoreAccount
        """
...
class UpdateService(object):
    def __init__(self, item_update, user):
        """
        :type item_update: inventorum_ebay.apps.products.models.EbayItemUpdateModel
        :type user: inventorum_ebay.apps.accounts.models.EbayUserModel
        """
        self.user = user
