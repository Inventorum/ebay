...
from inventorum_ebay.apps.products import tasks
from inventorum_ebay.apps.products.models import EbayProductModel, EbayItemModel, EbayItemUpdateModel, \
...
class CoreProductsSync(object):
    ...
    def _create_update_kwargs_from_diff(self, object, core_product_delta):
        """
        :type object: inventorum_ebay.apps.products.models.EbayUpdateModel
        :param core_product_delta: inventorum_ebay.apps.core_api.models.CoreProductDelta
        :rtype: dict
        """
        updated_attributes = {}
    ...
    def _create_variation_update_from_diff(self, ebay_variation, core_product_delta):
        ...
        :type core_product_delta: inventorum_ebay.apps.core_api.models.CoreProductDelta
    ...
    def _get_core_modifications_of_published_items(self, modified_since):
        ...
        :type modified_since: datetime
        :rtype: collections.Iterable[(EbayItemModel | EbayItemVariationModel, inventorum_ebay.apps.core_api.models.CoreProductDelta)]
        """
