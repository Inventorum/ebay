...
from inventorum_ebay.apps.products.serializers import EbayProductCategorySerializer, EbayProductSerializer
...
from inventorum_ebay.apps.shipping.tests import ShippingServiceConfigurableSerializerTest
