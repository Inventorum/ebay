...
from inventorum_ebay.apps.categories.models import CategoryModel, CategoryFeaturesModel, CategorySpecificModel, \
    DurationModel
from inventorum_ebay.apps.categories.tests.factories import CategoryFactory, DurationFactory, CategorySpecificFactory
...
class ProductTestMixin(ShippingServiceTestMixin):
    ...
    def valid_category(self):
        ...
        :rtype: inventorum_ebay.apps.categories.models.CategoryModel
        """
    ...
    def get_product(self, inv_id, account):
        ...
        :type inv_id: long
        :type account: inventorum_ebay.apps.accounts.tests.factories.EbayAccountFactory
