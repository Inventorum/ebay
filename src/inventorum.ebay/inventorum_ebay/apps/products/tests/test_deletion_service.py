...
from inventorum_ebay.apps.products.services import ProductDeletionService, UnpublishingService
...
class TestDeletionService(UnitTestCase):
    ...
    def mock_dependencies(self):
        unpublishing_service = "inventorum_ebay.apps.products.services.UnpublishingService"
