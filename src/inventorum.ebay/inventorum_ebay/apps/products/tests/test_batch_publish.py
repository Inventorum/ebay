...
from inventorum_ebay.tests import StagingTestAccount, ApiTest, IntegrationTest
...
class TestBatchPublish(EbayAuthenticatedAPITestCase, AccountTestMixin, ProductTestMixin):
    ...
    @mock.patch('inventorum_ebay.apps.products.resources.schedule_ebay_item_publish')
    @mock.patch('inventorum_ebay.apps.products.services.PublishingService.initialize_publish_attempt')
