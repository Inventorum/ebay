...
from inventorum_ebay.apps.products import EbayItemUpdateStatus
from inventorum_ebay.lib.core_api.tests import CoreApiTestHelpers
from inventorum_ebay.lib.core_api.tests.factories import CoreProductDeltaFactory
from inventorum_ebay.apps.products.core_products_sync import CoreProductsSync
from inventorum_ebay.apps.products.models import EbayProductModel, EbayItemVariationModel
from inventorum_ebay.apps.products.tasks import periodic_core_products_sync_task
from inventorum_ebay.apps.products.tests.factories import EbayProductFactory, PublishedEbayItemFactory
from inventorum_ebay.lib.celery import celery_test_case, get_anonymous_task_execution_context
from inventorum_ebay.tests import IntegrationTest
...
class UnitTestCoreProductsSync(UnitTestCase):
    ...
    def mock_dependencies(self):
        ...
        schedule_ebay_item_update = "inventorum_ebay.apps.products.tasks.schedule_ebay_item_update"
        self.schedule_ebay_item_update_mock = self.patch(schedule_ebay_item_update)

        schedule_ebay_product_deletion = "inventorum_ebay.apps.products.tasks.schedule_ebay_product_deletion"
