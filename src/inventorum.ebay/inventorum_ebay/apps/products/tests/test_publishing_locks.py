...
from inventorum_ebay.tests.live_server_test import ConcurrentLiveServerTestCase, ThreadedCoreAPIFake
from inventorum_ebay.tests.utils import JSONFixture, PatchMixin
...
class TestPublishingLocks(ConcurrentLiveServerTestCase, AccountTestMixin, ProductTestMixin, PatchMixin,
    ...
    def test_atomic_publishing(self):
        ...
        schedule_ebay_item_publish_mock = \
            self.patch('inventorum_ebay.apps.products.resources.schedule_ebay_item_publish')
