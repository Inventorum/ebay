...
from inventorum_ebay.apps.categories.tests.factories import CategoryFactory, CategorySpecificFactory, DurationFactory
...
from inventorum_ebay.apps.products.services import PublishingValidationException, PublishingPreparationService
from inventorum_ebay.apps.products.tests.factories import EbayProductModelFactory, EbayItemFactory
...
from inventorum_ebay.lib.core_api.tests.factories import CoreProductFactory, CoreProductVariationFactory, \
...
class UnitTestPublishingPreparationService(UnitTestCase, ShippingServiceTestMixin):
    ...
    def setup_mocked_dependencies(self):
        self.core_api_mock = self.patch('inventorum_ebay.apps.accounts.models.EbayUserModel.core_api',
    ...
    def get_valid_core_product(self):
        """
        :rtype: inventorum_ebay.lib.core_api.models.CoreProduct
        """
    ...
    def get_valid_core_info(self):
        """
        :rtype: inventorum_ebay.lib.core_api.models.CoreInfo
        """
    ...
    def expect_core_product(self, core_product):
        """
        :type core_product: inventorum_ebay.lib.core_api.models.CoreProduct
        """
    ...
    def expect_core_info(self, core_info):
        """
        :type core_info: inventorum_ebay.lib.core_api.models.CoreInfo
        """
