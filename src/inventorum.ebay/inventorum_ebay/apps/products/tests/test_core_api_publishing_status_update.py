...
from inventorum_ebay.apps.products.tests.factories import EbayItemFactory
...
class IntegrationTestCoreAPIPublishingStatusUpdate(APITestCase):
    ...
    def test_retrying(self):
        service_method = \
            "inventorum_ebay.apps.products.services.CorePublishingStatusUpdateService.update_publishing_status"
