...
from inventorum_ebay.apps.orders.models import OrderableItemModel

from inventorum_ebay.apps.shipping.models import ShippingServiceConfigurable
from inventorum_ebay.apps.products import EbayItemUpdateStatus, EbayApiAttemptType, EbayItemPublishingStatus
from inventorum_ebay.lib.db.fields import TaxRateField, MoneyField
from inventorum_ebay.lib.db.models import MappedInventorumModel, BaseModel, BaseQuerySet, MappedInventorumModelQuerySet
from inventorum_ebay.lib.ebay.data import EbayParser

from inventorum_ebay.lib.ebay.data.items import EbayItemShippingService, EbayFixedPriceItem, EbayPicture,\
    EbayItemSpecific, EbayVariation, EbayReviseFixedPriceItem, EbayReviseFixedPriceVariation, EbayReturnPolicy
from inventorum_ebay.lib.utils import translation
...
class EbayItemModel(OrderableItemModel, BaseModel):
    ...
    def _default_ebay_return_policy(self):
        ...
        :rtype: inventorum_ebay.lib.ebay.data.items.EbayReturnPolicy
        """
...
class EbayApiAttempt(BaseModel):
    ...
    def create_from_ebay_exception_for_item_and_type(cls, exception, item, type):
        """
        :type exception: inventorum_ebay.lib.ebay.EbayConnectionException
    ...
    def create_from_service_for_item_and_type(cls, service, item, type):
        ...
        :type service: inventorum_ebay.lib.ebay.items.EbayItems
        :type item: EbayItemModel
        :param type: unicode
        :return: EbayApiAttempt
        """
    ...
    def create_succeeded_update_attempt(cls, item_update, ebay):
        """
        :type item_update: EbayItemUpdateModel
        :type ebay_api: inventorum_ebay.lib.ebay.EbayTrading
        :return: EbayApiAttempt
        """
        return cls._create_update_attempt(
            item_update=item_update,
