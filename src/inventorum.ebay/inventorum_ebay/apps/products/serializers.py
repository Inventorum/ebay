...
from inventorum_ebay.apps.categories.serializers import CategorySerializer, CategoryBreadcrumbSerializer, \
    CategorySpecificsSerializer
from inventorum_ebay.apps.products.models import EbayProductModel, EbayProductSpecificModel
...
from inventorum_ebay.lib.rest.fields import RelatedModelByIdField, LazyPrimaryKeyRelatedField, InvIdField
...
class EbayProductSerializer(ShippingServiceConfigurableSerializer, serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'inv_id', 'category', 'is_published', 'listing_url', 'specific_values', 'is_click_and_collect',
                  'shipping_services', 'ean_does_not_apply')
    ...
    ean_does_not_apply = serializers.BooleanField()
