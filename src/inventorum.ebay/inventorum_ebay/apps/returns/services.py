...
import logging
from inventorum_ebay.lib.ebay.data.events import EbayEventReturnedItem, EbayEventReturned
...
class EbayReturnService(object):
    ...
    def __init__(self, account, return_model):
        ...
        :type return_model: inventorum_ebay.apps.returns.models.ReturnModel
        """
