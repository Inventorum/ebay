...
from inventorum_ebay.tests import EbayTest, Countries
...
from inventorum_ebay.apps.shipping.services import EbayShippingScraper
...
from inventorum_ebay.lib.ebay.tests.factories import EbayShippingServiceFactory, EbayTokenFactory
...
class UnitTestShippingScraper(UnitTestCase, ShippingServiceTestMixin):
    ...
    def setUp(self):
        ...
        self.get_shipping_services_mock =\
            self.patch("inventorum_ebay.lib.ebay.details.EbayDetails.get_shipping_services")

        self.ebay_token = EbayTokenFactory.create()

    def expect_shipping_services_from_ebay(self, services):
        """
        :type services: list[inventorum_ebay.lib.ebay.details.EbayShippingService]
        """
