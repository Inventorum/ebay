...
import logging
from inventorum_ebay.apps.notifications import EbayNotificationStatus
from inventorum_ebay.lib.db.models import BaseModel
...
class EbayNotificationModel(BaseModel):
    ...
    def create_from_ebay_notification(cls, notification):
        """
        :type notification: inventorum_ebay.lib.ebay.notifications.EbayNotification
        """
