...
import json
import logging
from inventorum_ebay.apps.notifications import EbayNotificationEventType
from inventorum_ebay.apps.notifications.fixtures import notification_templates
from inventorum_ebay.apps.notifications.tests import NotificationTestsMixin

from inventorum_ebay.apps.products import EbayItemPublishingStatus
from inventorum_ebay.apps.products.tests.factories import PublishedEbayItemFactory
...
class TestFixedPriceTransactionNotificationHandling(EbayAuthenticatedAPITestCase, NotificationTestsMixin):
    ...
    def setUp(self):
        ...
        self.schedule_ebay_orders_sync_mock = \
            self.patch("inventorum_ebay.apps.notifications.handlers.schedule_ebay_orders_sync")
...
class TestItemClosedNotificationHandling(EbayAuthenticatedAPITestCase, NotificationTestsMixin):
    ...
    def setUp(self):
        ...
        self.schedule_core_api_publishing_status_update_mock = \
            self.patch("inventorum_ebay.apps.notifications.handlers.schedule_core_api_publishing_status_update")
