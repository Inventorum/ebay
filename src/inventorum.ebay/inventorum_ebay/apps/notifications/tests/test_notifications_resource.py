...
from inventorum_ebay.apps.notifications.models import EbayNotificationModel

from inventorum_ebay.apps.notifications import EbayNotificationEventType, EbayNotificationStatus
...
class TestNotificationsResource(APITestCase, NotificationTestsMixin):
    ...
    def test_invalid_payload(self):
        response = self.client.post("/notifications/", content_type='text/xml; charset="utf-8"',
                                    HTTP_SOAPACTION=EbayNotificationEventType.FixedPriceTransaction,
