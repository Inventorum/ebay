...
from inventorum_ebay.apps.notifications import EbayNotificationEventType, handlers, EbayNotificationStatus
from inventorum_ebay.apps.notifications.handlers import EbayNotificationHandlerException
...
class EbayPlatformNotificationService(object):
    ...
    def handle(cls, notification):
        """
        :type notification: inventorum_ebay.apps.notifications.models.EbayNotificationModel
        """
    ...
    def _get_handler_for_event_type(cls, event_type, notification):
        ...
        :rtype: inventorum_ebay.apps.notifications.handlers.EbayNotificationHandler
        """
