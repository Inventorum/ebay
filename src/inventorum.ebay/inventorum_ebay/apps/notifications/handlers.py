...
from inventorum_ebay.apps.products.tasks import schedule_core_api_publishing_status_update

from inventorum_ebay.lib.ebay.data.responses import GetItemTransactionsResponseType, GetItemResponseType
...
class FixedPriceTransactionNotificationHandler(EbayNotificationHandler):
    ...
    def handle(self, payload):
        """
        :type payload: inventorum_ebay.lib.ebay.data.responses.GetItemTransactionsResponseType
        """
...
class ItemSoldNotificationHandler(EbayNotificationHandler):
    ...
    def handle(self, payload):
        """
        :type payload: inventorum_ebay.lib.ebay.data.responses.GetItemResponseType
        """
        item_id = payload.item.item_id
