...
from inventorum_ebay.apps.orders.services import CoreOrderService, EbayOrderStatusUpdateService
...
def periodic_core_orders_sync_task(self):
    ...
    :type self: inventorum.util.celery.InventorumTask
    """
    from inventorum_ebay.apps.orders.core_orders_sync import CoreOrdersSync
