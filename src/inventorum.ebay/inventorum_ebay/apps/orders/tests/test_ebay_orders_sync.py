...
from inventorum_ebay.apps.accounts.tests.factories import EbayAccountFactory, EbayUserFactory
from inventorum_ebay.apps.auth.models import EbayTokenModel
from inventorum_ebay.tests import MockedTest
from inventorum_ebay.apps.orders import CorePaymentMethod
from inventorum_ebay.apps.orders.ebay_orders_sync import EbayOrdersSync, IncomingEbayOrderSyncer, EbayOrderSyncException
from inventorum_ebay.apps.orders.models import OrderModel, OrderLineItemModel
from inventorum_ebay.apps.orders.tasks import periodic_ebay_orders_sync_task
from inventorum_ebay.apps.products.models import EbayItemVariationModel, EbayItemModel
from inventorum_ebay.apps.products.tests.factories import PublishedEbayItemFactory, EbayItemVariationFactory
from inventorum_ebay.apps.shipping import INV_CLICK_AND_COLLECT_SERVICE_EXTERNAL_ID
from inventorum_ebay.apps.shipping.models import ShippingServiceConfigurationModel
...
from inventorum_ebay.lib.core_api.tests import CoreApiTestHelpers
from inventorum_ebay.lib.ebay.data import EbayParser, OrderStatusCodeType, PaymentStatusCodeType, \
    BuyerPaymentMethodCodeType
from inventorum_ebay.lib.ebay.data.tests.factories import OrderTypeFactory, GetOrdersResponseTypeFactory, \
...
class IntegrationTestPeriodicEbayOrdersSync(EbayAuthenticatedAPITestCase, CoreApiTestHelpers, ShippingServiceTestMixin):
    ...
    def setUp(self):
        ...
        generate_random_mock = self.patch("inventorum_ebay.apps.orders.models.OrderModel.generate_unique_pickup_code")
...
class UnitTestEbayOrdersSync(UnitTestCase):
    ...
    def setUp(self):
        ...
        self.incoming_ebay_order_sync_mock = \
            self.patch("inventorum_ebay.apps.orders.ebay_orders_sync.IncomingEbayOrderSyncer.__call__")

        self.ebay_api_get_orders_mock = \
            self.patch("inventorum_ebay.lib.ebay.orders.EbayOrders.get_orders")

    def expect_ebay_orders(self, orders):
        """
        :type orders: list[inventorum_ebay.lib.ebay.data.responses.OrderType]
        """
...
class UnitTestEbayOrderSyncer(UnitTestCase, ShippingServiceTestMixin):
    ...
    def setUp(self):
        ...
        self.schedule_core_order_creation_mock = \
            self.patch("inventorum_ebay.apps.orders.tasks.schedule_core_order_creation")
