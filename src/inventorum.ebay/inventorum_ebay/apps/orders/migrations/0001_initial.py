    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit_price', inventorum_ebay.lib.db.fields.MoneyField(verbose_name='Unit price', max_digits=10, decimal_places=2)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subtotal', inventorum_ebay.lib.db.fields.MoneyField(null=True, max_digits=10, decimal_places=2, blank=True)),
                ('total', inventorum_ebay.lib.db.fields.MoneyField(null=True, max_digits=10, decimal_places=2, blank=True)),
                ('payment_method', models.CharField(max_length=255, null=True, blank=True)),
                ('payment_amount', inventorum_ebay.lib.db.fields.MoneyField(null=True, max_digits=10, decimal_places=2, blank=True)),
