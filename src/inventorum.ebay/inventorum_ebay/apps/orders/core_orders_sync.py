...
from inventorum_ebay.apps.orders import tasks
...
class CoreOrdersSync(object):
    ...
    def _get_modified_ebay_orders(self, modified_since):
        """
        :type modified_since:
        :rtype: collections.Iterable[(inventorum_ebay.apps.orders.models.OrderModel, inventorum_ebay.apps.core_api.models.CoreOrder)]
        """
...
class CoreOrderSyncer(object):
    ...
    def __call__(self, order, core_order):
        ...
        :type core_order: inventorum_ebay.apps.core_api.models.CoreOrder
        """
