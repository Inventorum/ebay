...
from inventorum_ebay.apps.orders import tasks, CorePaymentMethod
from inventorum_ebay.apps.orders.models import OrderModel, OrderLineItemModel, OrderFactory
from inventorum_ebay.apps.products.models import EbayItemModel, EbayItemVariationModel
from inventorum_ebay.apps.shipping.models import ShippingServiceModel, ShippingServiceConfigurationModel
from inventorum_ebay.lib.ebay.data import OrderStatusCodeType, TradingRoleCodeType, EbayParser
...
class IncomingEbayOrderSyncer(object):
    ...
    def __call__(self, ebay_order):
        """
        :type ebay_order: inventorum_ebay.lib.ebay.data.responses.OrderType
    ...
    def _create_order_line_item_model_from_ebay_transaction(self, order_model, ebay_transaction):
        ...
        :type ebay_transaction: inventorum_ebay.lib.ebay.data.responses.TransactionType
