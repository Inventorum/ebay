...
from inventorum.ebay.lib.ebay.data.events import EbayEventResponse
import requests
...
class EbayInboundEventsException(Exception):
    def __init__(self, errors, response):
        """
        :type errors:  list[inventorum.ebay.lib.ebay.data.events.EbayEventError]
...
class EbayInboundEvents(object):
    ...
    def build_request_payload(self, event):
        """
        :type payload: inventorum.ebay.lib.ebay.data.events.EbayEventBase
        :return: dict
        """
        return {
            "event": {
    ...
    def parse_response(self, response):
        ...
        :rtype: inventorum.ebay.lib.ebay.data.events.EbayEventResponse
        """
