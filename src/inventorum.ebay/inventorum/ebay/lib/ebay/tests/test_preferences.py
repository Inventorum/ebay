...
from inventorum.ebay.lib.ebay.preferences import EbayPreferences, SellerProfileType
...
class TestEbayPreferences(EbayAuthenticatedAPITestCase):
    ...
    def test_get_user_preferences(self):
        ...
        return_profiles = [p for p in supported_seller_profiles if p.profile_type == SellerProfileType.RETURN_POLICY
