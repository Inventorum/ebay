...
CELERYBEAT_SCHEDULE = {
	...
	'synchronise_ebay_item_to_api': {
        'task': 'inventorum.ebay.apps.products.tasks.synchronise_ebay_item_to_api',
        'schedule': timedelta(seconds=300),
        'kwargs': {
            'timeout': 300,
            'context': get_anonymous_task_execution_context()
...
CELERY_ROUTES = {
	...
	'inventorum.ebay.apps.products.tasks.synchronise_ebay_item_to_api': {'queue': 'syncing'},
