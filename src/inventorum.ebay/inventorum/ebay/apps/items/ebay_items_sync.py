...
class OldEbayItemImporter(object):
    ...
    def __init__(self, account):
        ...
        """
        self.account = account
        self.account.is_ebay_authenticated, "Account {} is not authenticated to ebay".format(account)
    ...
    def convert_to_ebay_item_model(self, ebay_item):
        ...
        item_model.category = CategoryModel(ebay_item.category_id)
        item_model.category_id = ebay_item.category_id
        ...
        item_model.product_id = ebay_item.sku.split('_')[1]
