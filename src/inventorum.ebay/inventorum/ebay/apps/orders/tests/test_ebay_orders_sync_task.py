...
class UnitTestEbayOrdersSyncTask(EbayAuthenticatedAPITestCase):
    ...
    def test_basic_logic(self):
        self.ebay_orders_sync_ctor_mock = \
            self.patch("inventorum.ebay.apps.orders.ebay_orders_sync.EbayOrdersSync")
        ...
        self.ebay_orders_sync_run_mock = \
            self.patch("inventorum.ebay.apps.orders.ebay_orders_sync.EbayOrdersSync.run", spec_set=EbayOrdersSync)
